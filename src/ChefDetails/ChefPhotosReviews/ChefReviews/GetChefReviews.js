      ...
      .then(function (response) {
        ...
        if (response.data.length > 0) {
          response.data.forEach(function (element) {
            chefReviews.push({
              Image: element.CustEmail ? 'http://d1q6lc2rasmdf5.cloudfront.net/CustomerPictures/' + element.CustEmail.S + '.jpg' : "https://d1q6lc2rasmdf5.cloudfront.net/CustomerPictures/ProfilePicture.jpg",
